...
fun RoundIconButton(
    ...
    Card(modifier = Modifier
        ...
        //then keyword in clickable is used to add another modifier or to concatenate with the existing modifier and thus can be added as soon as the click is detected
